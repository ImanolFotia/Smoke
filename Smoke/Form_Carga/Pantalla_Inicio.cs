    ...
    public partial class Pantalla_Inicio : Form
    {
        ...
        private void pagoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (oUSUARIO.Dev == 1)
            {
                ...
                MessageBox.Show("Tu suscripción mensual está activa. Recordá que vence el:" + Environment.NewLine + fechavencimiento);
                return;
            }
        ...
        private void cambiarPagoMensualToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                OPMM = cLogin.Obtener_PagoMensual();
                OPMM.Monto = Pago_Deseado;
                cLogin.ModificarMonto(OPMM);
